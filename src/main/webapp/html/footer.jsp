      ...
      <div class="widget-row">
        <div class="widget-row-col-1">
          ...
          <div class="widget-row-col-content">
            <p>Helmet cung cấp các loại nón bảo hiểm tốt, an toàn cho bạn.</p>
          </div>
          ...
          <div class="contact">
            <div class="contact-item">
              ...
              <div class="contact-content">
                <span>Linh Trung, Thủ Đức, TP Hồ Chí Minh</span>
              </div>
            </div>
            <div class="contact-item">
              <div class="contact-item-icon">
            ...
            <div class="contact-item">
              ...
              <div class="contact-content conatct-item-email">
                <span>Paan@domain.com</span><br />
                <span>22130004@domain.com</span>
              </div>
            </div>
          </div>
        </div>
...
<div class="copyright-wrap">
  <div class="container">
    <div class="copyright-content">
      <p>&copy; Copyright 2024 Helmet. Tất cả quyền được bảo lưu.</p>
    </div>
  </div>
</div>
