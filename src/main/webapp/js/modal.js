    ...
    $('#loginForm').submit(function(event){
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                $('.form-message-login').text('').hide();
                $('.form-message-username-check-login').text('').hide();
                $('.form-message-check-login').text('').hide();
    ...
    $('#registerForm').submit(function(event){
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                $('.form-message-register').text('').hide();
                $('.form-message-username').text('').hide();
                $('.form-message-name').text('').hide();
                $('.form-message-email').text('').hide();
                $('.form-message-password').text('').hide();
                $('.form-message-password-confi').text('').hide();
